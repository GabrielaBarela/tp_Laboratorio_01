...
/*int head=-1;
    int i;
    ePassenger passanger[5]=
    {
        {0,"Juan","Perez",100000,"qqq222",1,1},
        {0,"Daniela","Benitez",150000,"eee333",1,3},
        {0,"Pepito","Lomelio",300000,"www111",3,1},
        {0,"Teresa","Martinez",250000,"rrr444",1,2},
        {0,"Bautista","Lopez",200000,"ttt555",2,1}
    };
